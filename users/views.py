...
class RegisterView(CreateView):
    ...
    success_url = reverse_lazy("users:login")  # Перенаправление на авторизацию после регистрации

    def form_valid(self, form):
        messages.success(self.request, "Вы успешно зарегистрировались. Пожалуйста, войдите.")
